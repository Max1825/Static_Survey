<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deny.aspx.cs" Inherits="Survey.result" %>
        ...
        <section class="survey-page-body">
            <form name="surveyForm"  method="post" enctype="multipart/form-data" novalidate data-survey-page-form runat="server">                                    
                    <div class="survey-submit-actions center-text clearfix">
                        <h1>Access Denied</h1>
                        <p>You don't have permission to access this application. Please contact with helpdesk@kepland.com.vn to request access </p>
                        <div style="margin-top:20px;">
                            <img src="content/images/deny.png" alt="Access Denied" title="Access Denied" />
                        </div>
